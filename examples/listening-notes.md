...
| --- | --- | --- | --- | --- |
| `Create desert field music as editable MIDI.` | `砂漠` | `mirage_caravan_short.mid` | Mirage Caravan | Desert field loop: reed-like motif, 3+3+2 walking pulse, low pedal, sparse heat shimmer. |
...
| Prompt | MIDI | Notes |
| --- | --- | --- |
| `Create desert field music as editable MIDI.` | `examples/midi/mirage_caravan_short.mid` | Desert field loop with reed-like motif and 3+3+2 walking pulse. |
